...
export default function Home() {
    ...
    const generateArticleTitle = async (e: React.FormEvent) => {
        ...
        const response = await fetch("https://article-idea-generator-develop.vercel.app/api/generate", {
            method: "POST",
            headers: {
        ...
        <>
            <div className={`flex flex-col items-center m-0 `}>
                ...
                <div className="flex flex-col items-center pt-14 w-full px-4 md:px-0 max-w-screen-md">
                    <h1
                        className={`text-3xl font-bold text-gray-900 dark:text-zinc-300  sm:leading-9 sm:truncate mb-2 text-center sm:text-4xl lg:text-6xl xl:text-6xl`}
                    >
